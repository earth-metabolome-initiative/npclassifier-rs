//! Parallel classification CLI for packed `NPClassifier` bundles.
...
#[derive(Debug, Parser)]
#[command(name = "npclassifier-classify")]
...
struct Cli {
    ...
    variant: CliVariant,
    /// Override the worker threshold triple.
    #[arg(long)]
